...
// FIX: Added the 'style' prop to allow dynamic transformations on the SVG icon.
const ArrowIcon: React.FC<{ className?: string; style?: React.CSSProperties }> = ({ className, style }) => (
